...
!(function (n, t) {
    ...
    function m(n) {
        ...
        function z(n) {
            ...
            var a = l(n),
                ...
                u = o;
            return a < 0 && i++, o === s && ((u = 0), (i += a > 0 ? 1 : -1)), {abs: u + i * s * a, origin: o, rel: u};
        }
        ...
        function _(t) {
            var i;
            (i = t - T), w.push({distance: i, timestamp: r()}), w.length > 6 && (w = w.slice(-6)), (T = v(t));
            var e = H().abs;
            if (e !== M) {
                var a = null !== M;
            ...
            init: function (t) {
                ...
                !(function () {
                    ...
                    null !== r && (m = r),
                        ...
                        (y = m === k ? m : I(m, !0, 0)),
                    null === r && (b = m),
                    p(t, "align", !1) && m !== k && 0 === u[O(m)][2] && ((y -= 1 - u[O(m)][0]), (m = E(y - T))),
                        (x = v(x)),
                        (y = v(y));
                })(),
                    (i = t),
                ...
                var n = r(),
                    t = w.reduce(
                        function (t, i) {
                            ...
                            return (
                                n - r > 200 ||
                                (l(e) !== l(t.distance) && t.distance && (t = {distance: 0, lastTimestamp: 0, time: 0}),
                                t.time && (t.distance += e),
    ...
    function b(n) {
        ...
        function z(t) {
            ...
            ((g = 0), (f = !0), (b = !1), (h = !0), (v = t.id), A(t), (m = D(t)), n.emit("dragStarted"));
        }
        ...
        return function (e) {
            ...
            function m(n) {
                ...
                a(
                    e.container,
                    "reverse",
                    "rtl" !== ((t = e.container), window.getComputedStyle(t, null).getPropertyValue("direction")) || n ? null : ""
                ),
